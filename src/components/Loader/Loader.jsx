    ...
    return (
        <LoaderStyled className="loader">
                <div className="puzzle">
                    <svg fill="#ff6347" height="800px" width="800px" version="1.1" id="Layer_1"
			...
			c-0.844,0.078-1.69,0.139-2.534,0.184c-36.257,1.925-70.608-26.622-70.608-67.038C164.571,95.879,200.429,66.865,237.714,70.29z"
                    ...
                    <svg fill="#9ACD32" height="800px" width="800px" version="1.1" id="Layer_1"
                         xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 512.001 512.001">
                        <g>
			...
			c7.033,12.178,10.114,25.969,8.86,39.647c7.543,0,62.709,0,70.289,0V54.858C512,24.609,487.391,0.001,457.143,0.001z"/>
                    ...
                    <svg fill="#f7a106" height="800px" width="800px" version="1.1" id="Layer_1"
                         xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 512.001 512.001">
                        <g>
			...
			z"/>
                    ...
                    <svg fill="#3366FF" height="800px" width="800px" version="1.1" id="Layer_1"
                         xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 512.001 512.001">
                        <g>
