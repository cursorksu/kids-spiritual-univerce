export const UsersIcon = () => (
        <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M14 10C15.6569 10 17 8.65685 17 7C17 5.34315 15.6569 4 14 4" stroke="currentColor"
            ...
            <path d="M17 13C19.2091 13 21 14.7909 21 17C21 18.6569 19.6569 20 18 20" stroke="currentColor"
                  strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
);